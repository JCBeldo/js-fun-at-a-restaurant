...
var vegetables = ['tomato', 'spinach', 'leek', 'pumpkin', 'cabbage']

// Write the code to access the 3rd element of the Array, using bracket
// notation.
console.log("third Element: ", vegetables[2]);

// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruits = ['passionfruit', 'guava', 'papaya', 'lemon', 'orange', 'pinapple', 'strawberry']


// Write the code to access the 5th element of the array, using bracket notation.
console.log("5th Element: ", fruits[4]);
